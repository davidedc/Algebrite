...
(function() {
  ...
  init = function() {
    ...
    flag = 1;
    for (i = _k = 0; 0 <= NSYM ? _k < NSYM : _k > NSYM; i = 0 <= NSYM ? ++_k : --_k) {
      symtab[i] = new U();
    }
  ...
  defn = function() {
    var definitionOfInterest, defn_i, _k, _ref, _results;
    _results = [];
    for (defn_i = _k = 0, _ref = defn_str.length; 0 <= _ref ? _k < _ref : _k > _ref; defn_i = 0 <= _ref ? ++_k : --_k) {
  ...
  run = function(stringToBeRun) {
    var allReturnedStrings, collectedResult, error, indexOfPartRemainingToBeParsed, n;
  ...
  add_terms = function(n) {
    var h, s, subsetOfStack, _k, _l, _m, _results;
    stackAddsCount++;
    i = 0;
    h = tos - n;
    s = h;
    ...
    if (DEBUG) {
      _results = [];
      for (i = _m = 0; 0 <= tos ? _m < tos : _m > tos; i = 0 <= tos ? ++_m : --_m) {
  ...
  combine_terms = function(s, n) {
    var t, _k, _l, _m, _n, _o, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    i = 0;
    while (i < (n - 1)) {
      check_esc_flag();
      p3 = stack[s + i];
      ...
      if (istensor(p3) && istensor(p4)) {
        ...
        if (p1 !== symbol(NIL)) {
          stack[s + i] = p1;
          for (j = _k = _ref = i + 1, _ref1 = n - 1; _ref <= _ref1 ? _k < _ref1 : _k > _ref1; j = _ref <= _ref1 ? ++_k : --_k) {
      ...
      if (isnum(p3) && isnum(p4)) {
        ...
        p1 = pop();
        if (iszero(p1)) {
          for (j = _l = i, _ref2 = n - 2; i <= _ref2 ? _l < _ref2 : _l > _ref2; j = i <= _ref2 ? ++_l : --_l) {
            stack[s + j] = stack[s + j + 2];
          }
          n -= 2;
        } else {
          stack[s + i] = p1;
          for (j = _m = _ref3 = i + 1, _ref4 = n - 1; _ref3 <= _ref4 ? _m < _ref4 : _m > _ref4; j = _ref3 <= _ref4 ? ++_m : --_m) {
            stack[s + j] = stack[s + j + 1];
          }
          n--;
        }
      ...
      p1 = pop();
      if (iszero(p1)) {
        for (j = _n = i, _ref5 = n - 2; i <= _ref5 ? _n < _ref5 : _n > _ref5; j = i <= _ref5 ? ++_n : --_n) {
          stack[s + j] = stack[s + j + 2];
        }
        n -= 2;
        i--;
      ...
      multiply();
      stack[s + i] = pop();
      for (j = _o = _ref6 = i + 1, _ref7 = n - 1; _ref6 <= _ref7 ? _o < _ref7 : _o > _ref7; j = _ref6 <= _ref7 ? ++_o : --_o) {
        stack[s + j] = stack[s + j + 1];
      }
      n--;
      i--;
  ...
  __factorial = function(n) {
    ...
    b = bigInt(0);
    if (3 <= n) {
      for (i = _k = 3; 3 <= n ? _k <= n : _k >= n; i = 3 <= n ? ++_k : --_k) {
        b = bigInt(i);
        t = mmul(a, b);
        a = t;
      }
  ...
  circexp = function() {
    ...
    if (p1.k === TENSOR) {
      ...
      copy_tensor();
      p1 = pop();
      for (i = _k = 0, _ref = p1.tensor.nelem; 0 <= _ref ? _k < _ref : _k > _ref; i = 0 <= _ref ? ++_k : --_k) {
  ...
  yycontract = function() {
    var a, ai, an, b, h, k, l, m, n, ndim, nelem, _k, _l, _m, _n, _o, _p, _q, _ref;
    h = 0;
    i = 0;
    j = 0;
    k = 0;
    ...
    a = p1.tensor.elem;
    b = p2.tensor.elem;
    for (i = _m = 0; 0 <= ndim ? _m < ndim : _m > ndim; i = 0 <= ndim ? ++_m : --_m) {
      ai[i] = 0;
      an[i] = p1.tensor.dim[i];
    }
    for (i = _n = 0; 0 <= nelem ? _n < nelem : _n > nelem; i = 0 <= nelem ? ++_n : --_n) {
      push(zero);
      for (j = _o = 0; 0 <= n ? _o < n : _o > n; j = 0 <= n ? ++_o : --_o) {
        ai[l] = j;
        ai[m] = j;
        h = 0;
        for (k = _p = 0; 0 <= ndim ? _p < ndim : _p > ndim; k = 0 <= ndim ? ++_p : --_p) {
          h = (h * an[k]) + ai[k];
        }
        push(a[h]);
        add();
      ...
      b[i] = pop();
      for (j = _q = _ref = ndim - 1; _ref <= 0 ? _q <= 0 : _q >= 0; j = _ref <= 0 ? ++_q : --_q) {
        if (j === l || j === m) {
          continue;
        }
        if (++ai[j] < an[j]) {
  ...
  det = function() {
    ...
    if (i === n) {
      ...
      for (i = _l = 0, _ref = p1.tensor.nelem; 0 <= _ref ? _l < _ref : _l > _ref; i = 0 <= _ref ? ++_l : --_l) {
        push(p1.tensor.elem[i]);
      }
  ...
  determinant = function(n) {
    var a, breakFromOutherWhile, h, k, q, s, sign, t, _k, _l;
    h = 0;
    i = 0;
    j = 0;
    k = 0;
  ...
  lu_decomp = function(n) {
    var d, h, _k, _l, _m, _n, _o, _ref, _ref1, _ref2, _ref3;
    d = 0;
    h = 0;
    i = 0;
    j = 0;
    h = tos - n * n;
    p1 = one;
    for (d = _k = 0, _ref = n - 1; 0 <= _ref ? _k < _ref : _k > _ref; d = 0 <= _ref ? ++_k : --_k) {
      if (equal(M(h, n, d, d), zero)) {
        for (i = _l = _ref1 = d + 1; _ref1 <= n ? _l < n : _l > n; i = _ref1 <= n ? ++_l : --_l) {
        ...
        for (j = _m = d; d <= n ? _m < n : _m > n; j = d <= n ? ++_m : --_m) {
          p2 = M(h, n, d, j);
      ...
      multiply();
      p1 = pop();
      for (i = _n = _ref2 = d + 1; _ref2 <= n ? _n < n : _n > n; i = _ref2 <= n ? ++_n : --_n) {
        push(M(h, n, i, d));
        push(M(h, n, d, d));
        divide();
        negate();
        p2 = pop();
        setM(h, n, i, d, zero);
        for (j = _o = _ref3 = d + 1; _ref3 <= n ? _o < n : _o > n; j = _ref3 <= n ? ++_o : --_o) {
          push(M(h, n, d, j));
          push(p2);
          multiply();
          push(M(h, n, i, j));
  ...
  gen = function(h, k) {
    ...
    push(p3);
    expo = pop_integer();
    for (i = _k = 0, _ref = Math.abs(expo); 0 <= _ref ? _k <= _ref : _k >= _ref; i = 0 <= _ref ? ++_k : --_k) {
      push(p1);
      push(p2);
  ...
  EIG_check_arg = function() {
    ...
    for (i = _k = 0; 0 <= EIG_N ? _k < EIG_N : _k > EIG_N; i = 0 <= EIG_N ? ++_k : --_k) {
      for (j = _l = 0; 0 <= EIG_N ? _l < EIG_N : _l > EIG_N; j = 0 <= EIG_N ? ++_l : --_l) {
        if (!isdouble(p1.tensor.elem[EIG_N * i + j])) {
          stop("eigen: matrix is not numerical");
        }
      }
    }
    for (i = _m = 0, _ref = EIG_N - 1; 0 <= _ref ? _m < _ref : _m > _ref; i = 0 <= _ref ? ++_m : --_m) {
      for (j = _n = _ref1 = i + 1; _ref1 <= EIG_N ? _n < EIG_N : _n > EIG_N; j = _ref1 <= EIG_N ? ++_n : --_n) {
  ...
  eigen = function(op) {
    var _k, _l, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref2, _ref3, _results, _s, _t;
    i = 0;
    j = 0;
    for (i = _k = 0, _ref = EIG_N * EIG_N; 0 <= _ref ? _k < _ref : _k > _ref; i = 0 <= _ref ? ++_k : --_k) {
      EIG_yydd[i] = 0.0;
    }
    for (i = _l = 0, _ref1 = EIG_N * EIG_N; 0 <= _ref1 ? _l < _ref1 : _l > _ref1; i = 0 <= _ref1 ? ++_l : --_l) {
      EIG_yyqq[i] = 0.0;
    }
    for (i = _m = 0; 0 <= EIG_N ? _m < EIG_N : _m > EIG_N; i = 0 <= EIG_N ? ++_m : --_m) {
      EIG_yydd[EIG_N * i + i] = p1.tensor.elem[EIG_N * i + i].d;
      for (j = _n = _ref2 = i + 1; _ref2 <= EIG_N ? _n < EIG_N : _n > EIG_N; j = _ref2 <= EIG_N ? ++_n : --_n) {
        EIG_yydd[EIG_N * i + j] = p1.tensor.elem[EIG_N * i + j].d;
        EIG_yydd[EIG_N * j + i] = p1.tensor.elem[EIG_N * i + j].d;
      }
    }
    for (i = _o = 0; 0 <= EIG_N ? _o < EIG_N : _o > EIG_N; i = 0 <= EIG_N ? ++_o : --_o) {
      EIG_yyqq[EIG_N * i + i] = 1.0;
      for (j = _p = _ref3 = i + 1; _ref3 <= EIG_N ? _p < EIG_N : _p > EIG_N; j = _ref3 <= EIG_N ? ++_p : --_p) {
        EIG_yyqq[EIG_N * i + j] = 0.0;
        EIG_yyqq[EIG_N * j + i] = 0.0;
      }
    }
    for (i = _q = 0; _q < 100; i = ++_q) {
      if (step() === 0) {
        break;
      }
    }
    ...
    if (op === EIGEN || op === EIGENVEC) {
      ...
      p3 = pop();
      _results = [];
      for (i = _t = 0; 0 <= EIG_N ? _t < EIG_N : _t > EIG_N; i = 0 <= EIG_N ? ++_t : --_t) {
        _results.push((function() {
          var _results1, _u;
          _results1 = [];
          for (j = _u = 0; 0 <= EIG_N ? _u < EIG_N : _u > EIG_N; j = 0 <= EIG_N ? ++_u : --_u) {
  ...
  step2 = function(p, q) {
    var c, cc, k, s, ss, t, theta, _k, _l, _m;
    k = 0;
    t = 0.0;
    theta = 0.0;
    c = 0.0;
    ...
    for (k = _l = 0; 0 <= EIG_N ? _l < EIG_N : _l > EIG_N; k = 0 <= EIG_N ? ++_l : --_l) {
      cc = EIG_yydd[EIG_N * k + p];
      ss = EIG_yydd[EIG_N * k + q];
      EIG_yydd[EIG_N * k + p] = c * cc + s * ss;
      EIG_yydd[EIG_N * k + q] = c * ss - s * cc;
    }
    for (k = _m = 0; 0 <= EIG_N ? _m < EIG_N : _m > EIG_N; k = 0 <= EIG_N ? ++_m : --_m) {
  ...
  expand_tensor = function() {
    ...
    copy_tensor();
    p5 = pop();
    for (i = _k = 0, _ref = p5.tensor.nelem; 0 <= _ref ? _k < _ref : _k > _ref; i = 0 <= _ref ? ++_k : --_k) {
  ...
  expand_get_CF = function() {
    ...
    for (i = _k = 0; 0 <= n ? _k < n : _k > n; i = 0 <= n ? ++_k : --_k) {
      _results.push((function() {
        var _l, _results1;
        _results1 = [];
        for (j = _l = 0; 0 <= d ? _l < d : _l > d; j = 0 <= d ? ++_l : --_l) {
          push(p8);
          push(p6);
          push_integer(i);
          power();
  ...
  expand_get_AF = function() {
    ...
    d = pop_integer();
    _results = [];
    for (i = _k = n; n <= 0 ? _k < 0 : _k > 0; i = n <= 0 ? ++_k : --_k) {
      _results.push((function() {
        var _l, _results1;
        _results1 = [];
        for (j = _l = 0; 0 <= d ? _l < d : _l > d; j = 0 <= d ? ++_l : --_l) {
  ...
  factor_small_number = function() {
    ...
    for (i = _k = 0; 0 <= MAXPRIMETAB ? _k < MAXPRIMETAB : _k > MAXPRIMETAB; i = 0 <= MAXPRIMETAB ? ++_k : --_k) {
      d = primetab[i];
      if (d > n / d) {
        break;
      }
  ...
  yyfactorpoly = function() {
    ...
    push(zero);
    for (i = _k = 0; 0 <= factpoly_expo ? _k <= factpoly_expo : _k >= factpoly_expo; i = 0 <= factpoly_expo ? ++_k : --_k) {
  ...
  rationalize_coefficients = function(h) {
    ...
    i = 0;
    p7 = one;
    for (i = _k = h; h <= tos ? _k < tos : _k > tos; i = h <= tos ? ++_k : --_k) {
      push(stack[i]);
      denominator();
      push(p7);
      lcm();
    ...
    for (i = _l = h; h <= tos ? _l < tos : _l > tos; i = h <= tos ? ++_l : --_l) {
      push(p7);
      push(stack[i]);
      multiply();
      stack[i] = pop();
  ...
  get_factor = function() {
    var a0, an, h, na0, nan, rootsTries_i, rootsTries_j, _k, _l, _m, _n, _o;
    i = 0;
    j = 0;
    h = 0;
    a0 = 0;
    ...
    if (verbosing) {
      ...
      for (i = _l = 0; 0 <= na0 ? _l < na0 : _l > na0; i = 0 <= na0 ? ++_l : --_l) {
        printf(", ");
        print(stack[a0 + i]);
      }
      printf("\n");
      printf("divisors of leading term");
      for (i = _m = 0; 0 <= nan ? _m < nan : _m > nan; i = 0 <= nan ? ++_m : --_m) {
        printf(", ");
        print(stack[an + i]);
      }
      printf("\n");
    }
    for (rootsTries_i = _n = 0; 0 <= nan ? _n < nan : _n > nan; rootsTries_i = 0 <= nan ? ++_n : --_n) {
      for (rootsTries_j = _o = 0; 0 <= na0 ? _o < na0 : _o > na0; rootsTries_j = 0 <= na0 ? ++_o : --_o) {
  ...
  yydivpoly = function() {
    ...
    i = 0;
    p6 = zero;
    for (i = _k = factpoly_expo; factpoly_expo <= 0 ? _k < 0 : _k > 0; i = factpoly_expo <= 0 ? ++_k : --_k) {
      push(stack[polycoeff + i]);
  ...
  index_function = function(n) {
    var k, m, ndim, nelem, s, t, _k, _l, _m, _n, _o;
    i = 0;
    k = 0;
    m = 0;
    ndim = 0;
    ...
    nelem = 1;
    for (i = _m = m; m <= ndim ? _m < ndim : _m > ndim; i = m <= ndim ? ++_m : --_m) {
      nelem *= p1.tensor.dim[i];
    }
    p2 = alloc_tensor(nelem);
    p2.tensor.ndim = ndim - m;
    for (i = _n = m; m <= ndim ? _n < ndim : _n > ndim; i = m <= ndim ? ++_n : --_n) {
      p2.tensor.dim[i - m] = p1.tensor.dim[i];
    }
    for (i = _o = 0; 0 <= nelem ? _o < nelem : _o > nelem; i = 0 <= nelem ? ++_o : --_o) {
  ...
  set_component = function(n) {
    var k, m, ndim, s, t, _k, _l, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3;
    i = 0;
    k = 0;
    m = 0;
    ndim = 0;
    ...
    p3.tensor.ndim = p1.tensor.ndim;
    for (i = _m = 0, _ref = p1.tensor.ndim; 0 <= _ref ? _m < _ref : _m > _ref; i = 0 <= _ref ? ++_m : --_m) {
      p3.tensor.dim[i] = p1.tensor.dim[i];
    }
    for (i = _n = 0, _ref1 = p1.tensor.nelem; 0 <= _ref1 ? _n < _ref1 : _n > _ref1; i = 0 <= _ref1 ? ++_n : --_n) {
    ...
    for (i = _o = 0, _ref2 = p2.tensor.ndim; 0 <= _ref2 ? _o < _ref2 : _o > _ref2; i = 0 <= _ref2 ? ++_o : --_o) {
      if (p1.tensor.dim[m + i] !== p2.tensor.dim[i]) {
        stop("error in indexed assign");
      }
    }
    for (i = _p = 0, _ref3 = p2.tensor.nelem; 0 <= _ref3 ? _p < _ref3 : _p > _ref3; i = 0 <= _ref3 ? ++_p : --_p) {
  ...
  inner_f = function() {
    var a, ak, b, bk, c, k, n, ndim, _k, _l, _m, _n, _o, _p, _q, _ref, _ref1, _ref2, _ref3;
    i = 0;
    ...
    b = p2.tensor.elem;
    ak = 1;
    for (i = _k = 0, _ref = p1.tensor.ndim - 1; 0 <= _ref ? _k < _ref : _k > _ref; i = 0 <= _ref ? ++_k : --_k) {
      ak *= p1.tensor.dim[i];
    }
    bk = 1;
    for (i = _l = 1, _ref1 = p2.tensor.ndim; 1 <= _ref1 ? _l < _ref1 : _l > _ref1; i = 1 <= _ref1 ? ++_l : --_l) {
      bk *= p2.tensor.dim[i];
    }
    p3 = alloc_tensor(ak * bk);
    c = p3.tensor.elem;
    for (i = _m = 0; 0 <= ak ? _m < ak : _m > ak; i = 0 <= ak ? ++_m : --_m) {
      for (j = _n = 0; 0 <= n ? _n < n : _n > n; j = 0 <= n ? ++_n : --_n) {
        if (iszero(a[i * n + j])) {
          continue;
        }
        for (k = _o = 0; 0 <= bk ? _o < bk : _o > bk; k = 0 <= bk ? ++_o : --_o) {
          push(a[i * n + j]);
          push(b[j * bk + k]);
          multiply();
          push(c[i * bk + k]);
    ...
    if (ndim === 0) {
      ...
      p3.tensor.ndim = ndim;
      j = 0;
      for (i = _p = 0, _ref2 = p1.tensor.ndim - 1; 0 <= _ref2 ? _p < _ref2 : _p > _ref2; i = 0 <= _ref2 ? ++_p : --_p) {
        p3.tensor.dim[i] = p1.tensor.dim[i];
      }
      j = p1.tensor.ndim - 1;
      for (i = _q = 0, _ref3 = p2.tensor.ndim - 1; 0 <= _ref3 ? _q < _ref3 : _q > _ref3; i = 0 <= _ref3 ? ++_q : --_q) {
  ...
  yyinvg = function() {
    var h, n, _k, _l, _m, _n, _ref, _ref1;
    h = 0;
    i = 0;
    j = 0;
    n = 0;
    ...
    for (i = _m = 0, _ref = n * n; 0 <= _ref ? _m < _ref : _m > _ref; i = 0 <= _ref ? ++_m : --_m) {
      push(p1.tensor.elem[i]);
    }
    INV_decomp(n);
    p1 = alloc_tensor(n * n);
    ...
    p1.tensor.dim[0] = n;
    p1.tensor.dim[1] = n;
    for (i = _n = 0, _ref1 = n * n; 0 <= _ref1 ? _n < _ref1 : _n > _ref1; i = 0 <= _ref1 ? ++_n : --_n) {
      p1.tensor.elem[i] = stack[h + i];
    }
    tos -= 2 * n * n;
    return push(p1);
  ...
  INV_decomp = function(n) {
    var a, d, u, _k, _l, _m, _n, _ref, _results;
    a = 0;
    d = 0;
    i = 0;
    j = 0;
    ...
    u = a - n * n;
    _results = [];
    for (d = _k = 0; 0 <= n ? _k < n : _k > n; d = 0 <= n ? ++_k : --_k) {
      if (equal(stack[a + n * d + d], zero)) {
        for (i = _l = _ref = d + 1; _ref <= n ? _l < n : _l > n; i = _ref <= n ? ++_l : --_l) {
      ...
      _results.push((function() {
        var _o, _results1;
        _results1 = [];
        for (i = _o = 0; 0 <= n ? _o < n : _o > n; i = 0 <= n ? ++_o : --_o) {
          if (i === d) {
            continue;
          }
          p2 = stack[a + n * i + d];
          _results1.push((function() {
            var _p, _results2;
            _results2 = [];
            for (j = _p = 0; 0 <= n ? _p < n : _p > n; j = 0 <= n ? ++_p : --_p) {
              if (j > d) {
                push(stack[a + n * i + j]);
                push(stack[a + n * d + j]);
                push(p2);
  ...
  list = function(n) {
    var listIterator, _k, _results;
    listIterator = 0;
    push(symbol(NIL));
    _results = [];
    for (listIterator = _k = 0; 0 <= n ? _k < n : _k > n; listIterator = 0 <= n ? ++_k : --_k) {
      _results.push(cons());
    }
    return _results;
  };
  ...
  __normalize_radical_factors = function(h) {
    var _k, _l, _m, _ref, _ref1, _ref2;
    i = 0;
    if (isplusone(stack[h]) || isminusone(stack[h]) || isdouble(stack[h])) {
      return;
    }
    for (i = _k = _ref = h + 1; _ref <= tos ? _k < tos : _k > tos; i = _ref <= tos ? ++_k : --_k) {
    ...
    mp_numerator();
    p1 = pop();
    for (i = _l = _ref1 = h + 1; _ref1 <= tos ? _l < tos : _l > tos; i = _ref1 <= tos ? ++_l : --_l) {
    ...
    mp_denominator();
    p2 = pop();
    for (i = _m = _ref2 = h + 1; _ref2 <= tos ? _m < tos : _m > tos; i = _ref2 <= tos ? ++_m : --_m) {
      if (isplusone(p2)) {
        break;
      }
      if (!__is_radical_number(stack[i])) {
  ...
  for (initNRoots = _k = 0; 0 <= NROOTS_YMAX ? _k < NROOTS_YMAX : _k > NROOTS_YMAX; initNRoots = 0 <= NROOTS_YMAX ? ++_k : --_k) {
  ...
  monic = function(n) {
    ...
    for (k = _l = 0, _ref = n - 1; 0 <= _ref ? _l < _ref : _l > _ref; k = 0 <= _ref ? ++_l : --_l) {
  ...
  compute_fa = function(n) {
    ...
    _results = [];
    for (k = _l = 2; 2 <= n ? _l < n : _l > n; k = 2 <= n ? ++_l : --_l) {
  ...
  NROOTS_divpoly = function(n) {
    var k, _l, _m, _ref, _ref1, _results;
    k = 0;
    for (k = _l = _ref = n - 1; _ref <= 0 ? _l < 0 : _l > 0; k = _ref <= 0 ? ++_l : --_l) {
    ...
    _results = [];
    for (k = _m = 0, _ref1 = n - 1; 0 <= _ref1 ? _m < _ref1 : _m > _ref1; k = 0 <= _ref1 ? ++_m : --_m) {
  ...
  yyouter = function() {
    var k, ndim, nelem, _l, _m, _n, _o, _ref, _ref1, _ref2, _ref3;
    i = 0;
    j = 0;
    k = 0;
    ndim = 0;
    ...
    p3.tensor.ndim = ndim;
    for (i = _l = 0, _ref = p1.tensor.ndim; 0 <= _ref ? _l < _ref : _l > _ref; i = 0 <= _ref ? ++_l : --_l) {
      p3.tensor.dim[i] = p1.tensor.dim[i];
    }
    j = i;
    for (i = _m = 0, _ref1 = p2.tensor.ndim; 0 <= _ref1 ? _m < _ref1 : _m > _ref1; i = 0 <= _ref1 ? ++_m : --_m) {
      p3.tensor.dim[j + i] = p2.tensor.dim[i];
    }
    k = 0;
    for (i = _n = 0, _ref2 = p1.tensor.nelem; 0 <= _ref2 ? _n < _ref2 : _n > _ref2; i = 0 <= _ref2 ? ++_n : --_n) {
      for (j = _o = 0, _ref3 = p2.tensor.nelem; 0 <= _ref3 ? _o < _ref3 : _o > _ref3; j = 0 <= _ref3 ? ++_o : --_o) {
        push(p1.tensor.elem[i]);
  ...
  power_sum = function(n) {
    ...
    factorial();
    p1 = pop();
    for (i = _n = 0; 0 <= k ? _n < k : _n > k; i = 0 <= k ? ++_n : --_n) {
      a[i] = 0;
    }
    push(zero);
  ...
  multinomial_sum = function(k, n, a, i, m) {
    ...
    j = 0;
    if (i < k - 1) {
      for (j = _l = 0; 0 <= m ? _l <= m : _l >= m; j = 0 <= m ? ++_l : --_l) {
        a[i] = j;
    ...
    a[i] = m;
    push(p1);
    for (j = _m = 0; 0 <= k ? _m < k : _m > k; j = 0 <= k ? ++_m : --_m) {
      push_integer(a[j]);
      factorial();
      divide();
    }
    for (j = _n = 0; 0 <= k ? _n < k : _n > k; j = 0 <= k ? ++_n : --_n) {
  ...
  Eval_product = function() {
    ...
    p3 = get_arglist(p6);
    push_integer(1);
    for (i = _l = j; j <= k ? _l <= k : _l >= k; i = j <= k ? ++_l : --_l) {
      push_integer(i);
      p5 = pop();
      set_binding(p6, p5);
      push(p1);
  ...
  divpoly = function() {
    var dividend, divisor, h, m, n, x, _l;
    h = 0;
    i = 0;
    m = 0;
    n = 0;
  ...
  yysimfac = function(h) {
    ...
    for (i = _l = h; h <= tos ? _l < tos : _l > tos; i = h <= tos ? ++_l : --_l) {
      p1 = stack[i];
      for (j = _m = h; h <= tos ? _m < tos : _m > tos; j = h <= tos ? ++_m : --_m) {
        if (i === j) {
          continue;
        }
        p2 = stack[j];
  ...
  simplify_tensor = function() {
    ...
    for (i = _m = 0, _ref1 = p1.tensor.nelem; 0 <= _ref1 ? _m < _ref1 : _m > _ref1; i = 0 <= _ref1 ? ++_m : --_m) {
      push(p1.tensor.elem[i]);
      simplify();
  ...
  taylor = function() {
    ...
    push_integer(1);
    p5 = pop();
    for (i = _l = 1; 1 <= k ? _l <= k : _l >= k; i = 1 <= k ? ++_l : --_l) {
      push(p1);
      push(p2);
      derivative();
      p1 = pop();
  ...
  d_tensor_tensor = function() {
    var a, b, c, ndim, nelem, _l, _m, _n, _ref;
    i = 0;
    j = 0;
    ndim = 0;
    nelem = 0;
    ...
    c = p3.tensor.elem;
    for (i = _m = 0; 0 <= nelem ? _m < nelem : _m > nelem; i = 0 <= nelem ? ++_m : --_m) {
      for (j = _n = 0, _ref = p2.tensor.nelem; 0 <= _ref ? _n < _ref : _n > _ref; j = 0 <= _ref ? ++_n : --_n) {
        push(a[i]);
        push(b[j]);
        derivative();
  ...
  d_scalar_tensor = function() {
    ...
    a = p2.tensor.elem;
    b = p3.tensor.elem;
    for (i = _l = 0, _ref = p2.tensor.nelem; 0 <= _ref ? _l < _ref : _l > _ref; i = 0 <= _ref ? ++_l : --_l) {
      push(p1);
      push(a[i]);
      derivative();
      b[i] = pop();
  ...
  power_tensor = function() {
    ...
    push(p1);
    _results = [];
    for (i = _m = 1; 1 <= n ? _m < n : _m > n; i = 1 <= n ? ++_m : --_m) {
      push(p1);
      inner();
  ...
  promote_tensor = function() {
    var k, ndim, nelem, _l, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3, _ref4;
    i = 0;
    j = 0;
    k = 0;
    nelem = 0;
    ...
    p2 = p1.tensor.elem[0];
    for (i = _l = 1, _ref = p1.tensor.nelem; 1 <= _ref ? _l < _ref : _l > _ref; i = 1 <= _ref ? ++_l : --_l) {
    ...
    p3 = alloc_tensor(nelem);
    p3.tensor.ndim = ndim;
    for (i = _m = 0, _ref1 = p1.tensor.ndim; 0 <= _ref1 ? _m < _ref1 : _m > _ref1; i = 0 <= _ref1 ? ++_m : --_m) {
      p3.tensor.dim[i] = p1.tensor.dim[i];
    }
    for (j = _n = 0, _ref2 = p2.tensor.ndim; 0 <= _ref2 ? _n < _ref2 : _n > _ref2; j = 0 <= _ref2 ? ++_n : --_n) {
      p3.tensor.dim[i + j] = p2.tensor.dim[j];
    }
    k = 0;
    for (i = _o = 0, _ref3 = p1.tensor.nelem; 0 <= _ref3 ? _o < _ref3 : _o > _ref3; i = 0 <= _ref3 ? ++_o : --_o) {
      p2 = p1.tensor.elem[i];
      for (j = _p = 0, _ref4 = p2.tensor.nelem; 0 <= _ref4 ? _p < _ref4 : _p > _ref4; j = 0 <= _ref4 ? ++_p : --_p) {
  ...
  compatible = function(p, q) {
    ...
    for (i = _l = 0, _ref = p.tensor.ndim; 0 <= _ref ? _l < _ref : _l > _ref; i = 0 <= _ref ? ++_l : --_l) {
  ...
  transform = function(s) {
    ...
    push(p4);
    decomp();
    for (_l = 0, _len = s.length; _l < _len; _l++) {
      eachEntry = s[_l];
      if (DEBUG) {
  ...
  transpose = function() {
    var a, ai, an, b, k, l, m, ndim, nelem, t, _l, _m, _n, _o, _p, _q, _ref;
    i = 0;
    j = 0;
    k = 0;
    l = 0;
    ...
    ai = [];
    an = [];
    for (i = _l = 0; 0 <= MAXDIM ? _l < MAXDIM : _l > MAXDIM; i = 0 <= MAXDIM ? ++_l : --_l) {
      ai[i] = 0;
      an[i] = 0;
    }
    save();
    ...
    a = p1.tensor.elem;
    b = p2.tensor.elem;
    for (i = _n = 0; 0 <= ndim ? _n < ndim : _n > ndim; i = 0 <= ndim ? ++_n : --_n) {
      ai[i] = 0;
      an[i] = p1.tensor.dim[i];
    }
    for (i = _o = 0; 0 <= nelem ? _o < nelem : _o > nelem; i = 0 <= nelem ? ++_o : --_o) {
      ...
      an[m] = t;
      k = 0;
      for (j = _p = 0; 0 <= ndim ? _p < ndim : _p > ndim; j = 0 <= ndim ? ++_p : --_p) {
        k = (k * an[j]) + ai[j];
      }
      t = ai[l];
      ai[l] = ai[m];
