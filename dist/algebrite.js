...
(function() {
  ...
  run = function(stringToBeRun, generateLatex) {
    var allReturnedLatexStrings, allReturnedPlainStrings, collectedLatexResult, collectedPlainResult, error, error1, error2, i, indexOfPartRemainingToBeParsed, n, theErrorMessage;
  ...
  computeResultsAndJavaScriptFromAlgebra = function(codeFromAlgebraBlock) {
    var ae, code, i, latexResult, len, readableSummaryOfCode, ref2, result, testableStringIsIgnoredHere, userSimplificationsInProgramForm;
    ...
    ref2 = findDependenciesInScript(codeFromAlgebraBlock), testableStringIsIgnoredHere = ref2[0], result = ref2[1], code = ref2[2], readableSummaryOfCode = ref2[3], latexResult = ref2[4], errorMessage = ref2[5];
