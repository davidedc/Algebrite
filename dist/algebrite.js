...
(function() {
  ...
  predefinedSymbolsInGlobalScope_doNotTrackInDependencies = ["rationalize", "mag", "i", "pi", "sin", "cos"];
  ...
  addSymbolRightOfAssignment = function(theSymbol) {
    if (predefinedSymbolsInGlobalScope_doNotTrackInDependencies.indexOf(theSymbol) === -1 && symbolsRightOfAssignment.indexOf(theSymbol) === -1) {
      if (DEBUG) {
