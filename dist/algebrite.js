...
(function() {
  ...
  approxIrrationals = function(theFloat) {
    var ac, ad, ae, error, hypothesis, i, j, len, len1, likelyMultiplier, numberOfDigitsAfterTheDot, o, precision, ratio, ref, ref1, result, splitBeforeAndAfterDot;
    splitBeforeAndAfterDot = theFloat.toString().split(".");
    if (splitBeforeAndAfterDot.length === 2) {
      numberOfDigitsAfterTheDot = splitBeforeAndAfterDot[1].length;
      precision = 1 / Math.pow(10, numberOfDigitsAfterTheDot);
    ...
    for (ad = 0, len = ref.length; ad < len; ad++) {
      i = ref[ad];
      ref1 = [1, 2, 3, 5, 6, 7, 8, 10];
      for (ae = 0, len1 = ref1.length; ae < len1; ae++) {
        j = ref1[ae];
        console.log("i,j: " + i + "," + j);
        hypothesis = Math.sqrt(i / j);
        console.log("hypothesis: " + hypothesis);
  ...
  approxRationalsOfLogs = function(theFloat) {
    var ac, error, hypothesis, i, j, likelyMultiplier, numberOfDigitsAfterTheDot, o, precision, ratio, result, splitBeforeAndAfterDot;
    splitBeforeAndAfterDot = theFloat.toString().split(".");
    if (splitBeforeAndAfterDot.length === 2) {
      numberOfDigitsAfterTheDot = splitBeforeAndAfterDot[1].length;
      precision = 1 / Math.pow(10, numberOfDigitsAfterTheDot);
  ...
  approxSinusOfRationals = function(theFloat) {
    var ac, error, fraction, hypothesis, i, j, likelyMultiplier, numberOfDigitsAfterTheDot, o, precision, ratio, result, splitBeforeAndAfterDot;
    splitBeforeAndAfterDot = theFloat.toString().split(".");
    if (splitBeforeAndAfterDot.length === 2) {
      numberOfDigitsAfterTheDot = splitBeforeAndAfterDot[1].length;
      precision = 1 / Math.pow(10, numberOfDigitsAfterTheDot);
  ...
  approxSinusOfRationalMultiplesOfPI = function(theFloat) {
    var ac, error, fraction, hypothesis, i, j, likelyMultiplier, numberOfDigitsAfterTheDot, o, precision, ratio, result, splitBeforeAndAfterDot;
    splitBeforeAndAfterDot = theFloat.toString().split(".");
    if (splitBeforeAndAfterDot.length === 2) {
      numberOfDigitsAfterTheDot = splitBeforeAndAfterDot[1].length;
  ...
  approxAll = function(theFloat) {
    var approxLogsOfRationalsResult, approxRationalsOfLogsResult, approxRationalsOfPowersOfEResult, approxRationalsOfPowersOfPIResult, approxSinusOfRationalMultiplesOfPIResult, approxSinusOfRationalsResult, numberOfDigitsAfterTheDot, precision, splitBeforeAndAfterDot;
    splitBeforeAndAfterDot = theFloat.toString().split(".");
    if (splitBeforeAndAfterDot.length === 2) {
      numberOfDigitsAfterTheDot = splitBeforeAndAfterDot[1].length;
      precision = 1 / Math.pow(10, numberOfDigitsAfterTheDot);
    ...
    if (approxRationalsOfPowersOfEResult != null) {
      return approxRationalsOfPowersOfEResult;
    }
    approxRationalsOfPowersOfPIResult = approxRationalsOfPowersOfPI(theFloat);
    if (approxRationalsOfPowersOfPIResult != null) {
      return approxRationalsOfPowersOfPIResult;
    }
    approxSinusOfRationalsResult = approxSinusOfRationals(theFloat);
    if (approxSinusOfRationalsResult != null) {
      return approxSinusOfRationalsResult;
    }
    approxSinusOfRationalMultiplesOfPIResult = approxSinusOfRationalMultiplesOfPI(theFloat);
    if (approxSinusOfRationalMultiplesOfPIResult != null) {
      return approxSinusOfRationalMultiplesOfPIResult;
    }
    return null;
  };

  testApproxAll = function() {
    ...
    for (af = 0, len4 = ref4.length; af < len4; af++) {
      ...
      for (ag = 0, len5 = ref5.length; ag < len5; ag++) {
        ...
        returned = approxIrrationals(value);
        returnedValue = returned[2] * Math.sqrt(returned[3] / returned[4]);
        if (returned[1] === approx_rootOfRatio && Math.abs(value - returnedValue) > 1e-15) {
          console.log("fail testapproxIrrationals: " + "1 * sqrt( " + i + " / " + j + " ) . obtained: " + returned);
        }
      }
    }
    ...
    for (ah = 0, len6 = ref6.length; ah < len6; ah++) {
      ...
      for (aj = 0, len7 = ref7.length; aj < len7; aj++) {
        ...
        returned = approxIrrationals(value);
        returnedValue = returned[2] * Math.sqrt(returned[3] / returned[4]);
        if (returned[1] === approx_rootOfRatio && Math.abs(originalValue - returnedValue) > 1e-15) {
          console.log("fail testapproxIrrationals with 4 digits:: " + "1 * sqrt( " + i + " / " + j + " ) . obtained: " + returned);
        }
      }
    }
    ...
    value = Math.sqrt(2);
    if (approxAll(value)[0] !== "2 * sin( 1/4 * pi )") {
      console.log("fail testApproxAll: Math.sqrt(2)");
    }
    value = Math.sqrt(3);
    if (approxAll(value)[0] !== "2 * sin( 1/3 * pi )") {
    ...
    return console.log("testApproxAll done");
  };
