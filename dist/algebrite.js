...
(function() {
  ...
  addSymbolRightOfAssignment = function(theSymbol) {
    if (symbolsDisappearingInCodeGenerationStep.indexOf(theSymbol) === -1 && symbolsRightOfAssignment.indexOf(theSymbol) === -1) {
      if (DEBUG) {
  ...
  findDependenciesInScript = function(stringToBeParsed) {
    var ae, af, ag, ah, aj, allReturnedStrings, cyclesDescriptions, error, error1, generatedCode, i, indexOfPartRemainingToBeParsed, inited, key, len, len1, len2, len3, len4, n, parameters, recursedDependencies, scriptEvaluation, testableString, value, variablesWithCycles;
    inited = true;
    symbolsDependencies = {};
