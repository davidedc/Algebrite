...
(function() {
  ...
  approxTrigonometric = function(theFloat) {
    var ac, ad, ae, af, ag, error, fraction, hypothesis, i, j, likelyMultiplier, numberOfDigitsAfterTheDot, o, precision, ratio, result, splitBeforeAndAfterDot;
    splitBeforeAndAfterDot = theFloat.toString().split(".");
    if (splitBeforeAndAfterDot.length === 2) {
      numberOfDigitsAfterTheDot = splitBeforeAndAfterDot[1].length;
      precision = 1 / Math.pow(10, numberOfDigitsAfterTheDot);
    ...
    for (i = ad = 1; ad <= 4; i = ++ad) {
      for (j = ae = 1; ae <= 4; j = ++ae) {
        console.log("i,j: " + i + "," + j);
        fraction = i / j;
    ...
    for (i = af = 1; af <= 13; i = ++af) {
      for (j = ag = 1; ag <= 13; j = ++ag) {
        console.log("i,j: " + i + "," + j);
        fraction = i / j;
  ...
  testApproxTrigonometric = function() {
    var ac, ad, ae, af, ag, ah, aj, al, am, ao, ap, aq, ar, error, fraction, i, j, o, originalValue, returned, returnedFraction, returnedValue, value;
    for (i = o = 1; o <= 2; i = ++o) {
      for (j = ac = 1; ac <= 12; j = ++ac) {
    ...
    for (i = ad = 1; ad <= 2; i = ++ad) {
      for (j = ae = 1; ae <= 12; j = ++ae) {
    ...
    for (i = af = 1; af <= 4; i = ++af) {
      for (j = ag = 1; ag <= 4; j = ++ag) {
    ...
    for (i = ah = 1; ah <= 4; i = ++ah) {
      for (j = aj = 1; aj <= 4; j = ++aj) {
    ...
    for (i = al = 1; al <= 4; i = ++al) {
      for (j = am = 1; am <= 4; j = ++am) {
    ...
    value = 0;
    if (approxTrigonometric(value)[0] !== "0") {
      console.log("fail testApproxTrigonometric: 0");
    }
    value = 0.0;
    if (approxTrigonometric(value)[0] !== "0") {
      console.log("fail testApproxTrigonometric: 0.0");
    }
    value = Math.sqrt(2);
    if (approxTrigonometric(value)[0] !== "2 * sin( 1/4 * pi )") {
      console.log("fail testApproxTrigonometric: Math.sqrt(2)");
    }
    value = Math.sqrt(3);
    if (approxTrigonometric(value)[0] !== "2 * sin( 1/3 * pi )") {
      console.log("fail testApproxTrigonometric: Math.sqrt(3)");
    }
    value = (Math.sqrt(6) - Math.sqrt(2)) / 4;
    if (approxTrigonometric(value)[0] !== "1 * sin( 1/12 * pi )") {
      console.log("fail testApproxTrigonometric: (Math.sqrt(6) - Math.sqrt(2))/4");
    }
    value = Math.sqrt(2 - Math.sqrt(2)) / 2;
    if (approxTrigonometric(value)[0] !== "1 * sin( 1/8 * pi )") {
      console.log("fail testApproxTrigonometric: Math.sqrt(2 - Math.sqrt(2))/2");
    }
    value = (Math.sqrt(6) + Math.sqrt(2)) / 4;
    if (approxTrigonometric(value)[0] !== "1 * sin( 5/12 * pi )") {
      console.log("fail testApproxTrigonometric: (Math.sqrt(6) + Math.sqrt(2))/4");
    }
    value = Math.sqrt(2 + Math.sqrt(3)) / 2;
    if (approxTrigonometric(value)[0] !== "1 * sin( 5/12 * pi )") {
      console.log("fail testApproxTrigonometric: Math.sqrt(2 + Math.sqrt(3))/2");
    }
    value = (Math.sqrt(5) - 1) / 4;
    if (approxTrigonometric(value)[0] !== "1 * sin( 1/10 * pi )") {
      console.log("fail testApproxTrigonometric: (Math.sqrt(5) - 1)/4");
    }
    value = Math.sqrt(10 - 2 * Math.sqrt(5)) / 4;
    if (approxTrigonometric(value)[0] !== "1 * sin( 1/5 * pi )") {
      console.log("fail testApproxTrigonometric: Math.sqrt(10 - 2*Math.sqrt(5))/4");
    }
    value = Math.sin(Math.PI / 7);
    if (approxTrigonometric(value)[0] !== "1 * sin( 1/7 * pi )") {
      console.log("fail testApproxTrigonometric: Math.sin(Math.PI/7)");
    }
    value = Math.sin(Math.PI / 9);
    if (approxTrigonometric(value)[0] !== "1 * sin( 1/9 * pi )") {
      console.log("fail testApproxTrigonometric: Math.sin(Math.PI/9)");
    }
    for (i = ao = 1; ao <= 13; i = ++ao) {
      for (j = ap = 1; ap <= 13; j = ++ap) {
    ...
    for (i = aq = 1; aq <= 13; i = ++aq) {
      for (j = ar = 1; ar <= 13; j = ++ar) {
    ...
    return console.log("testApproxTrigonometric done");
  };
  ...
  collectLatexStringFromReturnValue = function(p) {
    var origPrintMode, returnedString;
    origPrintMode = printMode;
    printMode = PRINTMODE_LATEX;
  ...
  test_dependencies = function() {
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: a, ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: a, ; " && testResult[1] === "" && testResult[2] === "x = 1/10*Math.pow(2, (1/2));") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: 'x, g, y, ; " && testResult[1] === "" && testResult[2] === "f = function (g, y, x) { return ( g(y) + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
  ...
  findDependenciesInScript = function(stringToBeParsed, dontGenerateCode) {
    var ae, af, ag, ah, aj, al, allReturnedLatexStrings, allReturnedPlainStrings, am, bodyForReadableSummaryOfGeneratedCode, cyclesDescriptions, deQuotedDep, dependencyInfo, eachDependency, error, error1, error2, error3, generatedBody, generatedCode, i, indexOfPartRemainingToBeParsed, inited, key, len, len1, len2, len3, len4, len5, len6, n, parameters, readableSummaryOfGeneratedCode, recursedDependencies, scriptEvaluation, testableString, toBePrinted, userVariablesMentioned, value, variablesWithCycles;
    if (DEBUG) {
