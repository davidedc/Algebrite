...
(function() {
  ...
  exec = function() {
    var ae, args, fn, len, name, result;
    name = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    fn = get_binding(usr_symbol(name));
    check_stack();
    push(fn);
    for (ae = 0, len = args.length; ae < len; ae++) {
      arg = args[ae];
      parse_internal(arg);
    }
    list(1 + args.length);
