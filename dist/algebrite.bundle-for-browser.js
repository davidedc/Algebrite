...
(function() {
  ...
  issqrtthreeovertwo = function(p) {
    if (car(p) === symbol(MULTIPLY) && isoneovertwo(cadr(p)) && issqrtthree(caddr(p)) && length(p) === 3) {
      return 1;
    } else {
      return 0;
    }
  ...
  isminussqrtthreeovertwo = function(p) {
    if (car(p) === symbol(MULTIPLY) && isminusoneovertwo(cadr(p)) === 1 && issqrtthree(caddr(p)) === 1 && length(p) === 3) {
      return 1;
    } else {
      return 0;
    }
  ...
  issqrtthree = function(p) {
    if (car(p) === symbol(POWER) && equaln(cadr(p), 3) === 1 && isoneovertwo(caddr(p)) === 1) {
      return 1;
    } else {
      return 0;
    }
