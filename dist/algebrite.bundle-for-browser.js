...
(function() {
  ...
  findDependenciesInScript = function(stringToBeParsed) {
    var ae, af, ag, ah, allReturnedStrings, cyclesDescriptions, error, error1, i, indexOfPartRemainingToBeParsed, inited, key, len, len1, len2, len3, n, recursedDependencies, testableString, value, variablesWithCycles;
    inited = true;
    symbolsDependencies = {};
