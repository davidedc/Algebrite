test_roots = ->
	run_test [
		...
		"roots(thePoly)",
		"((-1/2*a*c-1/3*b*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)+1/6*b^2+1/6*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(2/3)-1/2*i*3^(1/2)*a*c+1/6*i*3^(1/2)*b^2-1/6*i*3^(1/2)*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(2/3))/(a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)),(-1/2*a*c-1/3*b*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)+1/6*b^2+1/6*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(2/3)+1/2*i*3^(1/2)*a*c-1/6*i*3^(1/2)*b^2+1/6*i*3^(1/2)*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(2/3))/(a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)),(a*c-1/3*b*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)-1/3*b^2-1/3*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(2/3))/(a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)))",
		...
		"roots(thePoly)",
		"(10/9-226/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))-1/9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3),10/9+113/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))+1/18*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)-113*i*3^(1/2)/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))+1/18*i*3^(1/2)*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3),10/9+113/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))+1/18*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)+113*i*3^(1/2)/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))-1/18*i*3^(1/2)*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))",
		...
		"roots(thePoly)",
		"(-2/3-1/3*73^(1/3),-2/3+1/6*73^(1/3)-1/6*i*3^(1/2)*73^(1/3),-2/3+1/6*73^(1/3)+1/6*i*3^(1/2)*73^(1/3))",
		...
		"roots(thePoly)",
		"(-7/3-47/((18117/2+27/2*34949^(1/2))^(1/3))-1/9*(18117/2+27/2*34949^(1/2))^(1/3),-7/3+47/(2*(18117/2+27/2*34949^(1/2))^(1/3))+1/18*(18117/2+27/2*34949^(1/2))^(1/3)-47*i*3^(1/2)/(2*(18117/2+27/2*34949^(1/2))^(1/3))+1/18*i*3^(1/2)*(18117/2+27/2*34949^(1/2))^(1/3),-7/3+47/(2*(18117/2+27/2*34949^(1/2))^(1/3))+1/18*(18117/2+27/2*34949^(1/2))^(1/3)+47*i*3^(1/2)/(2*(18117/2+27/2*34949^(1/2))^(1/3))-1/18*i*3^(1/2)*(18117/2+27/2*34949^(1/2))^(1/3))",
		...
		"(2/3-1/3*(-1)^(1/3)*37^(1/3),2/3-1/6*37^(1/3)+1/6*i*3^(1/2)*37^(1/3),2/3+1/3*37^(1/3))",
		...
		"roots(thePoly)",
		"(2/3-1/9*(108-243/2*i+27/2*(-1)^(-1/2+arctan(144/17)/(2*pi))*5^(1/2)*29^(1/2))^(1/3),2/3+1/18*(108-243/2*i+27/2*(-1)^(-1/2+arctan(144/17)/(2*pi))*5^(1/2)*29^(1/2))^(1/3)-1/18*i*3^(1/2)*(108-243/2*i+27/2*(-1)^(-1/2+arctan(144/17)/(2*pi))*5^(1/2)*29^(1/2))^(1/3),2/3+1/18*(108-243/2*i+27/2*(-1)^(-1/2+arctan(144/17)/(2*pi))*5^(1/2)*29^(1/2))^(1/3)+1/18*i*3^(1/2)*(108-243/2*i+27/2*(-1)^(-1/2+arctan(144/17)/(2*pi))*5^(1/2)*29^(1/2))^(1/3))",
