...
var ABS, ADD, ADJ, AND, ARCCOS, ARCCOSH, ARCSIN, ARCSINH, ARCTAN, ARCTANH, ARG, ATOMIZE, AUTOEXPAND, BAKE, BESSELJ, BESSELY, BINDING, BINOMIAL, BUF, C1, C2, C3, C4, C5, C6, CEILING, CHECK, CHOOSE, CIRCEXP, CLEAR, CLOCK, COEFF, COFACTOR, CONDENSE, CONJ, CONS, CONTRACT, COS, COSH, Condense, DEBUG, DECOMP, DEFINT, DEGREE, DENOMINATOR, DERIVATIVE, DET, DIM, DIRAC, DISPLAY, DIVISORS, DO, DOT, DOUBLE, DRAW, DRAWX, DSOLVE, E, EIGEN, EIGENVAL, EIGENVEC, ERF, ERFC, EVAL, EXP, EXPAND, EXPCOS, EXPSIN, Eval, Eval_Eval, Eval_abs, Eval_add, Eval_arctan, Eval_arg, Eval_binding, Eval_check, Eval_clear, Eval_coeff, Eval_condense, Eval_conj, Eval_cons, Eval_cos, Eval_denominator, Eval_derivative, Eval_det, Eval_dim, Eval_divisors, Eval_do, Eval_dsolve, Eval_exp, Eval_factor, Eval_factorial, Eval_factorpoly, Eval_gcd, Eval_hermite, Eval_hilbert, Eval_imag, Eval_index, Eval_inner, Eval_inv, Eval_invg, Eval_isinteger, Eval_lcm, Eval_log, Eval_mag, Eval_multiply, Eval_noexpand, Eval_number, Eval_numerator, Eval_operator, Eval_power, Eval_predicate, Eval_print, Eval_quote, Eval_rank, Eval_rationalize, Eval_real, Eval_rect, Eval_setq, Eval_simplify, Eval_sin, Eval_sqrt, Eval_stop, Eval_subst, Eval_sym, Eval_tensor, Eval_unit, Eval_user_function, Evalpoly, FACTOR, FACTORIAL, FACTORPOLY, FILTER, FLOATF, FLOOR, FOR, Find, GAMMA, GCD, HERMITE, HILBERT, IMAG, INDEX, INNER, INTEGRAL, INV, INVG, ISINTEGER, ISPRIME, LAGUERRE, LAST, LCM, LEADING, LEGENDRE, LOG, MAG, MAXDIM, MAXPRIMETAB, MAX_PROGRAM_SIZE, MEQUAL, METAA, METAB, METAX, MLENGTH, MOD, MP_MAX_FREE, MP_MIN_SIZE, MSIGN, MULTIPLY, MZERO, N, NIL, NOT, NROOTS, NSYM, NUM, NUMBER, NUMERATOR, OPERATOR, OR, OUTER, PI, POLAR, POWER, PRIME, PRINT, PRODUCT, QUOTE, QUOTIENT, RANK, RATIONALIZE, REAL, ROOTS, SECRETX, SELFTEST, SETQ, SGN, SIMPLIFY, SIN, SINH, SPACE_BETWEEN_COLUMNS, SPACE_BETWEEN_ROWS, SQRT, STOP, STR, SUBST, SUM, SYM, SYMBOL_A, SYMBOL_B, SYMBOL_C, SYMBOL_D, SYMBOL_I, SYMBOL_J, SYMBOL_N, SYMBOL_R, SYMBOL_S, SYMBOL_T, SYMBOL_X, SYMBOL_Y, SYMBOL_Z, TAN, TANH, TAYLOR, TENSOR, TEST, TESTEQ, TESTGE, TESTGT, TESTLE, TESTLT, TOS, TRACE, TRANSPOSE, TTY, T_DOUBLE, T_EQ, T_FUNCTION, T_GTEQ, T_INTEGER, T_LTEQ, T_NEWLINE, T_STRING, T_SYMBOL, U, UNIT, USR_SYMBOLS, YMAX, YYE, YYRECT, ZERO, __cmp, __emit_char, __emit_str, __factor_add, __factorial, __is_negative, __is_radical_number, __lcm, __normalize_radical_factors, __rationalize_tensor, absval, absval_tensor, ac, add, add_all, add_numbers, add_terms, addf, alloc_tensor, allocatedId, any_denominators, arctan, arg, arglist, bake, bake_poly, bake_poly_term, bignum_factorial, bignum_float, bignum_power_number, bignum_scan_float, bignum_scan_integer, bignum_truncate, binding, buffer, build_tensor, caaddr, caadr, caar, cadaddr, cadadr, cadar, caddaddr, caddadr, caddar, caddddr, cadddr, caddr, cadr, car, cdaddr, cdadr, cdar, cddaddr, cddar, cdddaddr, cddddr, cdddr, cddr, cdr, charTabIndex, chartab, check_esc_flag, check_stack, clear, clear_symbols, cmpGlyphs, cmp_expr, cmp_terms, cmp_terms_count, coeff, collectResultLine, combine_factors, combine_gammas, combine_terms, compare_numbers, compare_rationals, compare_tensors, compatible, conjugate, cons, consCount, convert_bignum_to_double, convert_rational_to_double, copy_tensor, cosine, cosine_of_angle, cosine_of_angle_sum, count, count_denominators, counter, d_scalar_scalar, d_scalar_scalar_1, d_scalar_tensor, d_tensor_scalar, d_tensor_tensor, dabs, darccos, darccosh, darcsin, darcsinh, darctan, darctanh, dbesselj0, dbesseljn, dbessely0, dbesselyn, dcos, dcosh, dd, define_user_function, defn, defn_str, denominator, derf, derfc, derivative, derivative_of_integral, dfunction, dhermite, display, display_flag, displaychar, divide, divide_numbers, divisors, divisors_onstack, dlog, doubleToReasonableString, dpow, dpower, dproduct, draw_flag, draw_stop_return, dsgn, dsin, dsinh, dsum, dtan, dtanh, dupl, echo_input, egcd, elelmIndex, elem, emit_denominator, emit_denominators, emit_expr, emit_factor, emit_factorial_function, emit_flat_tensor, emit_fraction, emit_function, emit_index_function, emit_multiply, emit_number, emit_numerators, emit_numerical_fraction, emit_power, emit_string, emit_subexpr, emit_symbol, emit_tensor, emit_tensor_inner, emit_term, emit_top_expr, emit_unsigned_expr, emit_x, endian, equal, equaln, equalq, error, errorMessage, esc_flag, expanding, exponential, expr_level, f1, f2, f3, f4, f5, f9, factor, factor_a, factor_again, factor_b, factor_number, factor_small_number, factor_term, factorial, factorpoly, factpoly_expo, fill_buf, fixup_fraction, fixup_power, flag, fmt_index, fmt_level, fmt_x, frame, free_stack, gcd, gcd_expr, gcd_expr_expr, gcd_factor_term, gcd_main, gcd_numbers, gcd_term_factor, gcd_term_term, ge, gen, get_arglist, get_binding, get_factor, get_next_token, get_printname, get_size, get_token, getdisplaystr, glyph, gp, guess, imag, imaginaryunit, index_function, init, inited, inner, inner_f, input_str, inverse, invert_number, is_denominator, is_factor, is_small_integer, is_square_matrix, isadd, isalnum, isalpha, iscomplexnumber, iscons, isdenominator, isdigit, isdouble, iseveninteger, isfactor, isfactorial, isfloating, isfraction, isimaginarynumber, isimaginaryunit, isinteger, isintegerfactor, iskeyword, isminusone, isminusoneoversqrttwo, isnegative, isnegativenumber, isnegativeterm, isnonnegativeinteger, isnpi, isnum, isoneover, isoneoversqrttwo, isplusone, ispoly, ispoly_expr, ispoly_factor, ispoly_term, isposint, ispower, isquarterturn, isrational, isspace, isstr, issymbol, issymbolic, istensor, iszero, lcm, length, lessp, level, list, logarithm, logbuf, logout, lookupsTotal, madd, mag, makePositive, makeSignSameAs, mask, mcmp, mcmpint, mdiv, mdivrem, meta_mode, mgcd, mint, mmod, mmul, move, mp_clr_bit, mp_denominator, mp_numerator, mp_set_bit, mpow, mprime, mroot, mshiftright, msub, mtotal, multinomial_sum, multiply, multiply_all, multiply_all_noexpand, multiply_denominators, multiply_denominators_factor, multiply_denominators_term, multiply_noexpand, multiply_numbers, n_factor_number, negate, negate_expand, negate_noexpand, negate_number, new_string, newline_flag, nil_symbols, normalize_angle, nterms, numerator, o, one, oneElement, out_buf, out_count, out_of_memory, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, parse_p1, parse_p2, peek, peek2, polycoeff, polyform, pop, pop_double, pop_frame, pop_integer, power, power_str, power_sum, power_tensor, primetab, print1, print_a_over_b, print_char, print_denom, print_double, print_expr, print_factor, print_it, print_multiply_sign, print_number, print_str, print_tensor, print_tensor_inner, print_term, printchar, printchar_nowrap, printline, program_buf, promote_tensor, push, push_cars, push_double, push_factor, push_frame, push_identity_matrix, push_integer, push_rational, push_symbol, push_terms, push_zero_matrix, qadd, qdiv, qmul, qpow, qpowf, quickfactor, quickpower, rational, rationalize, rationalize_coefficients, real, reciprocate, rect, ref, restore, rewrite_args, rewrite_args_tensor, run, s, save, scalar_times_tensor, scan, scan_expression, scan_factor, scan_function_call, scan_meta, scan_power, scan_relation, scan_stmt, scan_str, scan_string, scan_subexpr, scan_symbol, scan_term, scanned, selftest, setSignTo, set_binding, set_binding_and_arglist, set_component, setq_indexed, sfac_product, sfac_product_f, sign, sign_of_term, simplify, simplify_main, simplify_polar, simplify_tensor, simplify_trig, simplifyfactorials, sine, sine_of_angle, sine_of_angle_sum, sort_stack, square, ssqrt, stack, stackAddsCount, std_symbol, stop, stringToBePrinted, subf, subst, subtract, subtract_numbers, swap, symbol, symnum, symtab, tensor, tensor_plus_tensor, tensor_times_scalar, test, test_factor_number, test_flag, test_low_level, test_madd, test_maddf, test_mdiv, test_mdivf, test_mgcd, test_mmod, test_mmodf, test_mmul, test_mmulf, test_mpow, test_mprime, test_mroot, test_msub, test_msubf, test_multiply, test_power, test_quickfactor, test_scan, text_metric, token, token_buf, token_str, top_level_eval, tos, trigmode, try_kth_prime, ucmp, unique, unique_f, update_token_buf, usr_symbol, verbosing, will_be_displayed_as_fraction, yindex, yyarg, yycondense, yydivpoly, yyexpand, yyfactorpoly, yylcm, yylog, yymag, yymultiply, yypower, yyrationalize, zero;
...
add_terms = function(n) {
  var ac, ad, h, i, o, ref, ref1, results, subsetOfStack;
  stackAddsCount++;
  i = 0;
  h = tos - n;
  s = h;
...
s = ["arg(1+i)", "1/4*pi", "arg(1-i)", "-1/4*pi", "arg(-1+i)", "3/4*pi", "arg(-1-i)", "-3/4*pi", "arg((-1)^(1/3))", "1/3*pi", "arg(1+exp(i*pi/3))", "1/6*pi", "arg((-1)^(1/6)*exp(i*pi/6))", "1/3*pi", "arg(a)", "0", "arg(a*exp(b+i*pi/5))", "1/5*pi", "arg(-1)", "-pi", "arg(a)", "0", "arg(-a)", "-pi", "arg(-(-1)^(1/3))", "-2/3*pi", "arg(-exp(i*pi/3))", "-2/3*pi", "arg(-i)", "-1/2*pi", "arg((a+b*i)/(c+d*i))", "arctan(b/a)-arctan(d/c)"];
...
defn = function() {
  var ad, definitionOfInterest, i, n, ref1, results;
  i = 0;
  n = defn_str.length;
  results = [];
  for (i = ad = 0, ref1 = n; 0 <= ref1 ? ad < ref1 : ad > ref1; i = 0 <= ref1 ? ++ad : --ad) {
