...
combine_terms = function(s, n) {
  var aa, i, j, l, o, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, t, u, v, w;
  for (i = l = 0, ref = n; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
    ...
    if (isnum(p3) && isnum(p4)) {
      ...
      p1 = pop();
      if (iszero(p1)) {
        for (j = u = ref3 = i, ref4 = n - 2; ref3 <= ref4 ? u < ref4 : u > ref4; j = ref3 <= ref4 ? ++u : --u) {
          s[j] = s[j + 2];
        }
        n -= 2;
      } else {
        s[i] = p1;
        for (j = v = ref5 = i + 1, ref6 = n - 1; ref5 <= ref6 ? v < ref6 : v > ref6; j = ref5 <= ref6 ? ++v : --v) {
          s[j] = s[j + 1];
        }
        n--;
      }
    ...
    p1 = pop();
    if (iszero(p1)) {
      for (j = w = ref7 = i, ref8 = n - 2; ref7 <= ref8 ? w < ref8 : w > ref8; j = ref7 <= ref8 ? ++w : --w) {
        s[j] = s[j + 2];
      }
      n -= 2;
      i--;
    ...
    multiply();
    s[i] = pop();
    for (j = aa = ref9 = i + 1, ref10 = n - 1; ref9 <= ref10 ? aa < ref10 : aa > ref10; j = ref9 <= ref10 ? ++aa : --aa) {
      s[j] = s[j + 1];
    }
    n--;
    i--;
...
convert_rational_to_double = function(p) {
  var a, b, i, l, n, na, nb, o, ref, ref1, ref2, ref3, ref4, u;
  ...
  if (na < nb) {
    for (i = u = ref3 = na, ref4 = nb; ref3 <= ref4 ? u < ref4 : u > ref4; i = ref3 <= ref4 ? ++u : --u) {
      a = a / 4294967296.0;
      b = b / 4294967296.0 + p.q.b[i];
    }
  }
...
__normalize_radical_factors = function(h) {
  var i, l, o, ref, ref1, ref2, ref3, ref4, ref5, u;
  ...
  mp_denominator();
  p2 = pop();
  for (i = u = ref4 = h + 1, ref5 = tos; ref4 <= ref5 ? u < ref5 : u > ref5; i = ref4 <= ref5 ? ++u : --u) {
    if (isplusone(p2)) {
      break;
    }
    if (!__is_radical_number(stack[i])) {
...
power_sum = function(n) {
  var a, i, j, k, l, o, ref, ref1, ref2, u;
  a = [];
  i = 0;
  j = 0;
  k = 0;
  ...
  factorial();
  p1 = pop();
  for (i = u = 0, ref2 = k; 0 <= ref2 ? u < ref2 : u > ref2; i = 0 <= ref2 ? ++u : --u) {
    a[i] = 0;
  }
  push(zero);
...
multinomial_sum = function(k, n, a, i, m) {
  ...
  for (j = u = 0, ref2 = k; 0 <= ref2 ? u < ref2 : u > ref2; j = 0 <= ref2 ? ++u : --u) {
    push(A(j, a[j]));
    multiply();
  }
  return add();
...
tensor_plus_tensor = function() {
  var a, b, c, i, l, ndim, nelem, o, ref, ref1, ref2, u;
  i = 0;
  ndim = 0;
  nelem = 0;
  save();
  ...
  b = p2.tensor.elem;
  c = p3.tensor.elem;
  for (i = u = 0, ref2 = nelem; 0 <= ref2 ? u < ref2 : u > ref2; i = 0 <= ref2 ? ++u : --u) {
    push(a[i]);
    push(b[i]);
    add();
    c[i] = pop();
...
d_tensor_tensor = function() {
  var a, b, c, i, j, l, ndim, nelem, o, ref, ref1, ref2, u;
  i = 0;
  j = 0;
  ndim = 0;
  nelem = 0;
  ...
  c = p3.tensor.elem;
  for (i = o = 0, ref1 = nelem; 0 <= ref1 ? o < ref1 : o > ref1; i = 0 <= ref1 ? ++o : --o) {
    for (j = u = 0, ref2 = p2.tensor.nelem; 0 <= ref2 ? u < ref2 : u > ref2; j = 0 <= ref2 ? ++u : --u) {
      push(a[i]);
      push(b[j]);
      derivative();
...
promote_tensor = function() {
  var i, j, k, l, ndim, nelem, o, ref, ref1, ref2, ref3, ref4, u, v, w;
  i = 0;
  j = 0;
  k = 0;
  nelem = 0;
  ...
  for (j = u = 0, ref2 = p2.tensor.ndim; 0 <= ref2 ? u < ref2 : u > ref2; j = 0 <= ref2 ? ++u : --u) {
    p3.tensor.dim[i + j] = p2.tensor.dim[j];
  }
  k = 0;
  for (i = v = 0, ref3 = p1.tensor.nelem; 0 <= ref3 ? v < ref3 : v > ref3; i = 0 <= ref3 ? ++v : --v) {
    p2 = p1.tensor.elem[i];
    for (j = w = 0, ref4 = p2.tensor.nelem; 0 <= ref4 ? w < ref4 : w > ref4; j = 0 <= ref4 ? ++w : --w) {
