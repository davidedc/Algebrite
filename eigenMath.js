...
var ABS, ADD, ADJ, AND, ARCCOS, ARCCOSH, ARCSIN, ARCSINH, ARCTAN, ARCTANH, ARG, ATOMIZE, AUTOEXPAND, BAKE, BESSELJ, BESSELY, BINDING, BINOMIAL, BUF, C1, C2, C3, C4, C5, C6, CEILING, CHECK, CHOOSE, CIRCEXP, CLEAR, CLOCK, COEFF, COFACTOR, CONDENSE, CONJ, CONS, CONTRACT, COS, COSH, DECOMP, DEFINT, DEGREE, DENOMINATOR, DERIVATIVE, DET, DIM, DIRAC, DISPLAY, DIVISORS, DO, DOT, DOUBLE, DRAW, DRAWX, DSOLVE, E, EIGEN, EIGENVAL, EIGENVEC, ERF, ERFC, EVAL, EXP, EXPAND, EXPCOS, EXPSIN, Eval, Eval_Eval, Eval_add, Eval_binding, Eval_check, Eval_coeff, Eval_cons, Eval_det, Eval_dim, Eval_divisors, Eval_do, Eval_dsolve, Eval_exp, Eval_factorial, Eval_factorpoly, Eval_hermite, Eval_hilbert, Eval_index, Eval_inv, Eval_invg, Eval_isinteger, Eval_multiply, Eval_noexpand, Eval_number, Eval_operator, Eval_power, Eval_predicate, Eval_print, Eval_quote, Eval_rank, Eval_setq, Eval_sqrt, Eval_stop, Eval_subst, Eval_sym, Eval_tensor, Eval_unit, FACTOR, FACTORIAL, FACTORPOLY, FILTER, FLOATF, FLOOR, FOR, Find, GAMMA, GCD, HERMITE, HILBERT, IMAG, INDEX, INNER, INTEGRAL, INV, INVG, ISINTEGER, ISPRIME, LAGUERRE, LAST, LCM, LEADING, LEGENDRE, LOG, MAG, MAXDIM, MAXPRIMETAB, MAX_PROGRAM_SIZE, MEQUAL, METAA, METAB, METAX, MLENGTH, MOD, MP_MAX_FREE, MP_MIN_SIZE, MSIGN, MULTIPLY, MZERO, NIL, NOT, NROOTS, NSYM, NUM, NUMBER, NUMERATOR, OPERATOR, OR, OUTER, PI, POLAR, POWER, PRIME, PRINT, PRODUCT, QUOTE, QUOTIENT, RANK, RATIONALIZE, REAL, ROOTS, SECRETX, SELFTEST, SETQ, SGN, SIMPLIFY, SIN, SINH, SQRT, STOP, STR, SUBST, SUM, SYM, SYMBOL_A, SYMBOL_B, SYMBOL_C, SYMBOL_D, SYMBOL_I, SYMBOL_J, SYMBOL_N, SYMBOL_R, SYMBOL_S, SYMBOL_T, SYMBOL_X, SYMBOL_Y, SYMBOL_Z, TAN, TANH, TAYLOR, TENSOR, TEST, TESTEQ, TESTGE, TESTGT, TESTLE, TESTLT, TOS, TRACE, TRANSPOSE, TTY, T_DOUBLE, T_EQ, T_FUNCTION, T_GTEQ, T_INTEGER, T_LTEQ, T_NEWLINE, T_STRING, T_SYMBOL, U, UNIT, USR_SYMBOLS, YYE, YYRECT, ZERO, __cmp, __factorial, __is_radical_number, __normalize_radical_factors, add, add_all, add_numbers, add_terms, addf, alloc_tensor, any_denominators, arglist, bake, bake_poly, bake_poly_term, bignum_factorial, bignum_float, bignum_power_number, bignum_scan_float, bignum_scan_integer, bignum_truncate, binding, build_tensor, caaddr, caadr, caar, cadaddr, cadadr, cadar, caddaddr, caddadr, caddar, caddddr, cadddr, caddr, cadr, car, cdaddr, cdadr, cdar, cddaddr, cddar, cdddaddr, cddddr, cdddr, cddr, cdr, check_esc_flag, check_stack, clear_symbols, cmp_expr, cmp_terms, coeff, combine_factors, combine_gammas, combine_terms, compare_numbers, compare_rationals, compare_tensors, compatible, cons, convert_bignum_to_double, convert_rational_to_double, copy_tensor, counter, d_scalar_tensor, d_tensor_scalar, d_tensor_tensor, define_user_function, defn, defn_str, display, divide, divide_numbers, draw_flag, draw_stop_return, dupl, echo_input, endian, equal, equaln, equalq, error, esc_flag, expanding, exponential, flag, fmt_index, fmt_level, fmt_x, frame, free_stack, gcd_numbers, ge, get_arglist, get_binding, get_next_token, get_printname, get_token, gp, imaginaryunit, init, inited, input_str, inverse, invert_number, is_denominator, is_factor, is_small_integer, is_square_matrix, isadd, isalnum, isalpha, iscomplexnumber, iscons, isdigit, isdouble, iseveninteger, isfactorial, isfloating, isfraction, isimaginarynumber, isimaginaryunit, isinteger, isintegerfactor, iskeyword, isminusone, isminusoneoversqrttwo, isnegative, isnegativenumber, isnegativeterm, isnonnegativeinteger, isnpi, isnum, isoneover, isoneoversqrttwo, isplusone, ispoly, ispoly_expr, ispoly_factor, ispoly_term, isposint, ispower, isquarterturn, isrational, isspace, isstr, issymbol, issymbolic, istensor, iszero, length, lessp, list, logbuf, madd, makePositive, makeSignSameAs, mask, mcmp, mcmpint, mdiv, meta_mode, mgcd, mmod, mmul, mp_clr_bit, mp_denominator, mp_numerator, mp_set_bit, mshiftright, msub, mtotal, multinomial_sum, multiply, multiply_all, multiply_all_noexpand, multiply_noexpand, multiply_numbers, negate, negate_expand, negate_noexpand, negate_number, new_string, newline_flag, normalize_angle, one, out_buf, out_count, out_of_memory, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, parse_p1, parse_p2, peek, peek2, polyform, pop, pop_double, pop_frame, pop_integer, power, power_sum, power_tensor, primetab, print1, print_double, print_expr, print_factor, print_multiply_sign, print_number, print_str, print_term, printline, program_buf, promote_tensor, push, push_cars, push_double, push_frame, push_identity_matrix, push_integer, push_rational, push_symbol, push_terms, push_zero_matrix, qadd, qmul, qpow, qpowf, rational, reciprocate, restore, run, s, save, scalar_times_tensor, scan, scan_expression, scan_factor, scan_function_call, scan_meta, scan_power, scan_relation, scan_stmt, scan_str, scan_string, scan_subexpr, scan_symbol, scan_term, scanned, set_binding, set_binding_and_arglist, setq_indexed, sign, sign_of_term, simplify_polar, sort_stack, square, ssqrt, stack, std_symbol, stop, subf, subst, subtract, subtract_numbers, swap, symbol, symnum, symtab, tensor, tensor_plus_tensor, tensor_times_scalar, testString, test_flag, test_madd, test_maddf, test_msub, test_msubf, test_scan, text_metric, token, token_buf, token_str, top_level_eval, tos, trigmode, ucmp, unique, unique_f, update_token_buf, usr_symbol, verbosing, yyexpand, yymultiply, yypower, zero;
...
add_terms = function(n) {
  var h, i, l, o, ref, ref1, results, s, subsetOfStack, w;
  h = tos - n;
  s = h;
  ...
  results = [];
  for (i = w = 0, ref1 = tos; 0 <= ref1 ? w < ref1 : w > ref1; i = 0 <= ref1 ? ++w : --w) {
...
combine_terms = function(s, n) {
  debugger;
  var ac, ad, ae, i, j, l, o, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, t, w;
  for (i = l = 0, ref = n - 1; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
    ...
    if (istensor(p3) && istensor(p4)) {
      ...
      if (p1 !== symbol(NIL)) {
        stack[s + i] = p1;
        for (j = o = ref1 = i + 1, ref2 = n - 1; ref1 <= ref2 ? o < ref2 : o > ref2; j = ref1 <= ref2 ? ++o : --o) {
    ...
    if (isnum(p3) && isnum(p4)) {
      ...
      p1 = pop();
      if (iszero(p1)) {
        for (j = w = ref3 = i, ref4 = n - 2; ref3 <= ref4 ? w < ref4 : w > ref4; j = ref3 <= ref4 ? ++w : --w) {
          stack[s + j] = stack[s + j + 2];
        }
        n -= 2;
      } else {
        stack[s + i] = p1;
        for (j = ac = ref5 = i + 1, ref6 = n - 1; ref5 <= ref6 ? ac < ref6 : ac > ref6; j = ref5 <= ref6 ? ++ac : --ac) {
          stack[s + j] = stack[s + j + 1];
        }
        n--;
      }
    ...
    p1 = pop();
    if (iszero(p1)) {
      for (j = ad = ref7 = i, ref8 = n - 2; ref7 <= ref8 ? ad < ref8 : ad > ref8; j = ref7 <= ref8 ? ++ad : --ad) {
        stack[s + j] = stack[s + j + 2];
      }
      n -= 2;
      i--;
    ...
    multiply();
    stack[s + i] = pop();
    for (j = ae = ref9 = i + 1, ref10 = n - 1; ref9 <= ref10 ? ae < ref10 : ae > ref10; j = ref9 <= ref10 ? ++ae : --ae) {
      stack[s + j] = stack[s + j + 1];
    }
    n--;
    i--;
...
convert_rational_to_double = function(p) {
  var a, b, i, l, n, na, nb, o, ref, ref1, ref2, ref3, ref4, w;
  ...
  if (na > nb) {
    for (i = o = ref1 = nb, ref2 = na; ref1 <= ref2 ? o < ref2 : o > ref2; i = ref1 <= ref2 ? ++o : --o) {
      a = a / 4294967296.0 + p.q.a[i];
      b = b / 4294967296.0;
    }
  }
  if (na < nb) {
    for (i = w = ref3 = na, ref4 = nb; ref3 <= ref4 ? w < ref4 : w > ref4; i = ref3 <= ref4 ? ++w : --w) {
      a = a / 4294967296.0;
      b = b / 4294967296.0 + p.q.b[i];
    }
  }
...
Find = function(p, q) {
  ...
  if (istensor(p)) {
    for (i = l = 0, ref = p.tensor.nelem; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
...
init = function() {
  ...
  for (i = o = 0, ref1 = NSYM; 0 <= ref1 ? o < ref1 : o > ref1; i = 0 <= ref1 ? ++o : --o) {
    symtab[i].k = SYM;
    binding[i] = symtab[i];
    arglist[i] = symbol(NIL);
  }
...
test_madd = function() {
  ...
  logout("test madd\n");
  m = mtotal;
  for (i = l = -100; l < 100; i = ++l) {
    for (j = o = -100; o < 100; j = ++o) {
      test_maddf(i, j, i + j);
    }
  }
  if (m !== mtotal) {
...
push_identity_matrix = function(n) {
  ...
  results = [];
  for (i = l = 0, ref = n; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
    results.push(stack[tos - 1].tensor.elem[i * n + i] = one);
  }
  return results;
};
...
yymultiply = function() {
  ...
  if (expanding) {
    for (i = l = ref = h, ref1 = tos; ref <= ref1 ? l < ref1 : l > ref1; i = ref <= ref1 ? ++l : --l) {
      if (isadd(stack[i])) {
        multiply_all(tos - h);
        return;
      }
...
__normalize_radical_factors = function(h) {
  var i, l, o, ref, ref1, ref2, ref3, ref4, ref5, w;
  if (isplusone(stack[h]) || isminusone(stack[h]) || isdouble(stack[h])) {
    return;
  }
  for (i = l = ref = h + 1, ref1 = tos; ref <= ref1 ? l < ref1 : l > ref1; i = ref <= ref1 ? ++l : --l) {
  ...
  mp_numerator();
  p1 = pop();
  for (i = o = ref2 = h + 1, ref3 = tos; ref2 <= ref3 ? o < ref3 : o > ref3; i = ref2 <= ref3 ? ++o : --o) {
  ...
  mp_denominator();
  p2 = pop();
  for (i = w = ref4 = h + 1, ref5 = tos; ref4 <= ref5 ? w < ref5 : w > ref5; i = ref4 <= ref5 ? ++w : --w) {
    if (isplusone(p2)) {
      break;
    }
    if (!__is_radical_number(stack[i])) {
...
power_sum = function(n) {
  var a, i, j, k, l, o, ref, ref1, ref2, w;
  a = [];
  i = 0;
  j = 0;
  k = 0;
  ...
  factorial();
  p1 = pop();
  for (i = w = 0, ref2 = k; 0 <= ref2 ? w < ref2 : w > ref2; i = 0 <= ref2 ? ++w : --w) {
    a[i] = 0;
  }
  push(zero);
...
multinomial_sum = function(k, n, a, i, m) {
  var j, l, o, ref, ref1, ref2, w;
  j = 0;
  if (i < k - 1) {
    for (j = l = 0, ref = m; 0 <= ref ? l <= ref : l >= ref; j = 0 <= ref ? ++l : --l) {
      a[i] = j;
  ...
  a[i] = m;
  push(p1);
  for (j = o = 0, ref1 = k; 0 <= ref1 ? o < ref1 : o > ref1; j = 0 <= ref1 ? ++o : --o) {
    push_integer(a[j]);
    factorial();
    divide();
  }
  for (j = w = 0, ref2 = k; 0 <= ref2 ? w < ref2 : w > ref2; j = 0 <= ref2 ? ++w : --w) {
    push(A(j, a[j]));
    multiply();
  }
  return add();
...
qpowf = function() {
  ...
  if (isinteger(p2)) {
    ...
    x = mpow(p1.q.a, abs(expo));
    y = mpow(p1.q.b, abs(expo));
    if (expo < 0) {
      t = x;
      x = y;
      y = t;
...
subst = function() {
  ...
  if (istensor(p1)) {
    ...
    for (i = o = 0, ref1 = p1.tensor.nelem; 0 <= ref1 ? o < ref1 : o > ref1; i = 0 <= ref1 ? ++o : --o) {
...
Eval_tensor = function() {
  var a, b, i, l, ndim, nelem, o, ref, ref1;
  i = 0;
  ndim = 0;
  nelem = 0;
  ...
  p2.tensor.ndim = ndim;
  for (i = l = 0, ref = ndim; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
    p2.tensor.dim[i] = p1.tensor.dim[i];
  }
  a = p1.tensor.elem;
  b = p2.tensor.elem;
  for (i = o = 0, ref1 = nelem; 0 <= ref1 ? o < ref1 : o > ref1; i = 0 <= ref1 ? ++o : --o) {
    push(a[i]);
    Eval();
    b[i] = pop();
  }
...
tensor_plus_tensor = function() {
  var a, b, c, i, l, ndim, nelem, o, ref, ref1, ref2, w;
  i = 0;
  ndim = 0;
  nelem = 0;
  save();
  ...
  p3.tensor.ndim = ndim;
  for (i = o = 0, ref1 = ndim; 0 <= ref1 ? o < ref1 : o > ref1; i = 0 <= ref1 ? ++o : --o) {
    p3.tensor.dim[i] = p1.tensor.dim[i];
  }
  a = p1.tensor.elem;
  b = p2.tensor.elem;
  c = p3.tensor.elem;
  for (i = w = 0, ref2 = nelem; 0 <= ref2 ? w < ref2 : w > ref2; i = 0 <= ref2 ? ++w : --w) {
    push(a[i]);
    push(b[i]);
    add();
    c[i] = pop();
...
d_tensor_tensor = function() {
  var a, b, c, i, j, l, ndim, nelem, o, ref, ref1, ref2, w;
  i = 0;
  j = 0;
  ndim = 0;
  nelem = 0;
  ...
  c = p3.tensor.elem;
  for (i = o = 0, ref1 = nelem; 0 <= ref1 ? o < ref1 : o > ref1; i = 0 <= ref1 ? ++o : --o) {
    for (j = w = 0, ref2 = p2.tensor.nelem; 0 <= ref2 ? w < ref2 : w > ref2; j = 0 <= ref2 ? ++w : --w) {
      push(a[i]);
      push(b[j]);
      derivative();
...
d_scalar_tensor = function() {
  ...
  a = p2.tensor.elem;
  b = p3.tensor.elem;
  for (i = l = 0, ref = p2.tensor.nelem; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
    push(p1);
    push(a[i]);
    derivative();
    b[i] = pop();
...
power_tensor = function() {
  var i, k, l, n, o, ref, ref1, results;
  i = 0;
  k = 0;
  n = 0;
  k = p1.tensor.ndim - 1;
...
promote_tensor = function() {
  var ac, ad, i, j, k, l, ndim, nelem, o, ref, ref1, ref2, ref3, ref4, w;
  i = 0;
  j = 0;
  k = 0;
  nelem = 0;
  ...
  p2 = p1.tensor.elem[0];
  for (i = l = 1, ref = p1.tensor.nelem; 1 <= ref ? l < ref : l > ref; i = 1 <= ref ? ++l : --l) {
  ...
  p3 = alloc_tensor(nelem);
  p3.tensor.ndim = ndim;
  for (i = o = 0, ref1 = p1.tensor.ndim; 0 <= ref1 ? o < ref1 : o > ref1; i = 0 <= ref1 ? ++o : --o) {
    p3.tensor.dim[i] = p1.tensor.dim[i];
  }
  for (j = w = 0, ref2 = p2.tensor.ndim; 0 <= ref2 ? w < ref2 : w > ref2; j = 0 <= ref2 ? ++w : --w) {
    p3.tensor.dim[i + j] = p2.tensor.dim[j];
  }
  k = 0;
  for (i = ac = 0, ref3 = p1.tensor.nelem; 0 <= ref3 ? ac < ref3 : ac > ref3; i = 0 <= ref3 ? ++ac : --ac) {
    p2 = p1.tensor.elem[i];
    for (j = ad = 0, ref4 = p2.tensor.nelem; 0 <= ref4 ? ad < ref4 : ad > ref4; j = 0 <= ref4 ? ++ad : --ad) {
...
compatible = function(p, q) {
  ...
  for (i = l = 0, ref = p.tensor.ndim; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
