...
defn = function() {
  var ac, definitionOfInterest, n, ref1, results;
  i = 0;
  n = defn_str.length;
  results = [];
  for (i = ac = 0, ref1 = n; 0 <= ref1 ? ac < ref1 : ac > ref1; i = 0 <= ref1 ? ++ac : --ac) {
...
inner_f = function() {
  var a, ac, ad, ae, af, ag, ah, ai, ak, b, bk, c, j, k, n, ndim, ref1, ref2, ref3, ref4, ref5, ref6, ref7;
