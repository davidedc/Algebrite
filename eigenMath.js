...
combine_terms = function(s, n) {
  var ac, ad, ae, af, i, j, l, o, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, t;
  for (i = l = 0, ref = n - 1; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
    ...
    if (isnum(p3) && isnum(p4)) {
      ...
      p1 = pop();
      if (iszero(p1)) {
        for (j = ac = ref3 = i, ref4 = n - 2; ref3 <= ref4 ? ac < ref4 : ac > ref4; j = ref3 <= ref4 ? ++ac : --ac) {
          stack[s + j] = stack[s + j + 2];
        }
        n -= 2;
      } else {
        stack[s + i] = p1;
        for (j = ad = ref5 = i + 1, ref6 = n - 1; ref5 <= ref6 ? ad < ref6 : ad > ref6; j = ref5 <= ref6 ? ++ad : --ad) {
          stack[s + j] = stack[s + j + 1];
        }
        n--;
      }
    ...
    p1 = pop();
    if (iszero(p1)) {
      for (j = ae = ref7 = i, ref8 = n - 2; ref7 <= ref8 ? ae < ref8 : ae > ref8; j = ref7 <= ref8 ? ++ae : --ae) {
        stack[s + j] = stack[s + j + 2];
      }
      n -= 2;
      i--;
    ...
    multiply();
    stack[s + i] = pop();
    for (j = af = ref9 = i + 1, ref10 = n - 1; ref9 <= ref10 ? af < ref10 : af > ref10; j = ref9 <= ref10 ? ++af : --af) {
      stack[s + j] = stack[s + j + 1];
    }
    n--;
    i--;
...
convert_rational_to_double = function(p) {
  var a, ac, b, i, l, n, na, nb, o, ref, ref1, ref2, ref3, ref4;
  ...
  if (na < nb) {
    for (i = ac = ref3 = na, ref4 = nb; ref3 <= ref4 ? ac < ref4 : ac > ref4; i = ref3 <= ref4 ? ++ac : --ac) {
      a = a / 4294967296.0;
      b = b / 4294967296.0 + p.q.b[i];
    }
  }
...
for (i = l = 0, ref = YMAX; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
  chartab[i] = new glyph();
}
...
fixup_fraction = function(x, k1, k2) {
  var dx, dy, h1, h2, o, ref1, ref2, ref3, results, w, w1, w2, y, y1, y2;
  dx = 0;
  dy = 0;
  i = 0;
  w = 0;
...
get_size = function(j, k) {
  var h, max_x, max_y, min_x, min_y, o, ref1, ref2, w, y;
  min_x = chartab[j].x;
  max_x = chartab[j].x;
  min_y = chartab[j].y;
  max_y = chartab[j].y;
...
emit_number = function(p, emit_sign) {
  var ac, ad, o, ref1, ref2, ref3, results, results1;
  switch (p.k) {
    case NUM:
      s = p.q.a.toString();
      if (s[0] === '-' && emit_sign === 0) {
...
print_it = function() {
  var accumulatedPrint, o, ref1, subsetOfStack, x, y;
  accumulatedPrint = "";
...
fill_buf = function() {
  var o, ref1, sIndex, subsetOfStack, x, y;
  s = buffer;
  sIndex = 0;
  subsetOfStack = chartab.slice(0, yindex);
  subsetOfStack.sort(cmpGlyphs);
...
emit_tensor = function(p) {
  var ac, ad, ae, af, col, dx, dy, eh, ew, h, n, ncol, nrow, ref1, ref2, ref3, ref4, ref5, row, w, x, y;
  i = 0;
  n = 0;
  nrow = 0;
  ncol = 0;
...
__normalize_radical_factors = function(h) {
  var ac, ad, ae, ref1, ref2, ref3, ref4, ref5, ref6;
...
power_sum = function(n) {
  var a, ac, ad, ae, j, k, ref1, ref2, ref3;
  a = [];
  i = 0;
  j = 0;
  k = 0;
...
run = function(stringToBeRun) {
  var indexOfPartRemainingToBeParsed, n, results;
...
Eval_tensor = function() {
  var a, ac, ad, b, ndim, nelem, ref1, ref2;
  i = 0;
  ndim = 0;
  nelem = 0;
...
tensor_plus_tensor = function() {
  var a, ac, ad, ae, b, c, ndim, nelem, ref1, ref2, ref3;
  i = 0;
  ndim = 0;
  nelem = 0;
  save();
...
d_tensor_tensor = function() {
  var a, ac, ad, ae, b, c, j, ndim, nelem, ref1, ref2, ref3;
  i = 0;
  j = 0;
  ndim = 0;
  nelem = 0;
...
power_tensor = function() {
  var ac, ad, k, n, ref1, ref2, results;
  i = 0;
  k = 0;
  n = 0;
  k = p1.tensor.ndim - 1;
...
promote_tensor = function() {
  var ac, ad, ae, af, ag, j, k, ndim, nelem, ref1, ref2, ref3, ref4, ref5;
  i = 0;
  j = 0;
  k = 0;
  nelem = 0;
